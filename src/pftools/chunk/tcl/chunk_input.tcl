...
# Files
#
set home_dir         {C:/Reed/chunk_dist/chunk_dist_3-07}
set exe_file         {C:/Reed/chunk_dist/chunk_dist_3-07/code/chunk_0804.exe}
set par_file         {C:/Reed/chunk_dist/chunk_dist_3-07/code/chunk.par}
set tcl_file         {C:/Reed/chunk_dist/chunk_dist_3-07/tcl/chunk_input.tcl}
set chunk_run_file   {chunk_run_0701.tcl}
set ps_file          {C:/Reed/chunk_dist/chunk_dist_3-07/ps/chunk.ps}
...
set eps_date {03/23/07}
set eps_time {17:48:44}
#
# Plot
#
...
set field_file {C:/Reed/chunk_dist/chunk_dist_3-07/test/field_test.ascii}
set field_nuft_timestep 1
set field_n_cutoffs 1
set field_cutoff(1) 1.0
set field_cutoff_color(1) #000000
set field_value_min 0.0
set field_value_max 5.0
set field_color_table {C:/Reed/chunk_dist/chunk_dist_3-07/ctb/rainbow10.ctb}
set field_color 1
set field_n_bit 4
...
#
set field_legend_n_categories 1
set field_legend_n_rows 3
set field_legend_n_columns 2
set field_legend_category(1) 1
set field_legend_category_name(1) {Category 1}
#
# Surface
#
