...
#if defined(_CRAYMPP)
#define CALL_PF_EFDC PF_CALL_EFDC
#elif defined(__bg__)
#define CALL_PF_EFDC pf_call_efdc
#else
#define CALL_PF_EFDC pf_call_efdc_
#endif

#define PF_CALL_EFDC(PF_EFDC_NPROC,INFO,EFDCCOMM,EFDCINTERCOMM) \
  CALL_PF_EFDC(PF_EFDC_NPROC,INFO,EFDCCOMM,EFDCINTERCOMM);

void CALL_PF_EFDC(MPI_Fint *PF_EFDC_NPROC, MPI_Fint *INFO,MPI_Fint *EFDCCOMM,MPI_Fint *EFDCINTERCOMM);
